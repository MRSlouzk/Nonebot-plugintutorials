...
> PS：MessageSegment和Message可以通过"+"直接拼在一起，形成"文字+图片"类型的消息，另外Message之间也可以相互拼接。Message相当于一个数组，可以容纳一定数量的同类(Message)以及MessageSegment [官方文档](https://v2.nonebot.dev/docs/tutorial/message#%E6%8B%BC%E6%8E%A5%E6%B6%88%E6%81%AF)
